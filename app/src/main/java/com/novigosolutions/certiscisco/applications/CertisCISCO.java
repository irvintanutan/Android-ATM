...
public class CertisCISCO extends Application {
    ...
    public void onCreate() {
        super.onCreate();
        Configuration dbConfiguration = new Configuration.Builder(this).setDatabaseName("certiscisco.db").setDatabaseVersion(4).addModelClasses(Job.class, Cartridge.class, Seal.class, OtherScan.class, TestCash.class, CoinEnvelopes.class, EditRequests.class, ClearHistoryRequests.class).create();
