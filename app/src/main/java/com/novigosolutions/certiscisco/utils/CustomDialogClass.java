...
public class CustomDialogClass extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_operation_mode = (TextView) findViewById(R.id.txt_operation_mode);
        txt_atm_code = (TextView) findViewById(R.id.txt_atm_code);
        ...
        llloadmsg = (LinearLayout) findViewById(R.id.llloadmsg);
        llunloadmsg = (LinearLayout) findViewById(R.id.llunloadmsg);
        llbtns = (LinearLayout) findViewById(R.id.llbtns);
        btncomplete.setOnClickListener(this);
        btncancel.setOnClickListener(this);
        btnok.setOnClickListener(this);
        loadingno=(TextView)findViewById(R.id.loadingno);
        unloadingno=(TextView)findViewById(R.id.unloadingno);
        loadingrecyclerview = (RecyclerView) findViewById(R.id.loadingrecyclerview);
        unloadingrecyclerview = (RecyclerView) findViewById(R.id.unloadingrecyclerview);
